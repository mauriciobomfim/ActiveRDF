...
<em>To use ActiveRDF with Sesame or Jena, you must use it with JRuby. </em>
To install ActiveRDF on JRuby, use the command below:
...
<b>To use ActiveRDF with OWLIM-SE store, you must get OWLIM-SE >= 4.1 at http://www.ontotext.com/owlim.</b>
